...
#define IDENTIFICATION_TIMEOUT_MS 3000
#define INST_SEND_RETRY_COUNT 1
#define INST_SEND_GAP_MS 1
...
#define TEST_UDP_MODE_BROADCAST 1
#define TEST_UDP_MODE_UNICAST 2
#define TEST_UDP_MODE TEST_UDP_MODE_UNICAST
